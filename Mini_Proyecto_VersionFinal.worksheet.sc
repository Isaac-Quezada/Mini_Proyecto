...
simspon(0,1,ejemplo5)
simpsonCompuesta(0 , 1 , 50 ,ejemplo5)  
simpsonExtendida(0 , 1 ,ejemplo5) 


//Ejemplo 6
val ejemplo6 = ((x : Double) => 1 / math.sqrt(x-1))
simspon(2,3,ejemplo6)
simpsonCompuesta(2 , 3 , 10 ,ejemplo6)  
simpsonExtendida(2 , 3 ,ejemplo6) 

//Ejemplo 7
val ejemplo7 = ((x : Double) => 1 / 1 + math.pow(x,2))
simspon(0,1,ejemplo7)
simpsonCompuesta(0,1, 20 ,ejemplo7)  
simpsonExtendida(0,1 ,ejemplo7) 
